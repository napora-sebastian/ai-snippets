...
This project is indexed by GitNexus as **ai-managing** (1775 symbols, 3224 relationships, 153 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
- **MUST** update gitNexus analysis tree after finishing edits in the code.
